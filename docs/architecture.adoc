...
|Ziel
|Der Client des Domänenobjektes mit soll nicht selbst entscheiden müssen, wie er die richtige Kind-Entität bzw. die Referenz auflösen muss.
|===

Um dem Client den Abruf der Entität zu erleichtern, bzw. das Wissen darüber, wie die unterschiedlichen Quellen zur Auflösung der Kind-Entität zu nutzen sind, löst das Aggregate dieses auf. 
